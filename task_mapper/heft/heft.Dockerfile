...
ADD app_specific_files/network_monitoring_app_xdag/configuration.txt  /heft/dag.txt
ADD app_specific_files/network_monitoring_app_xdag/scripts/config.json /heft/config.json
